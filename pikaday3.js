...
}(this, function (moment)
{
    ...
    renderFoot = function(opts)
    {
        var i, arr = [];
        if (opts.showWeekNumber) {
            arr.push('<td class="pika-foot">&nbsp;</td>');
        }
        arr.push('<td class="pika-foot">&nbsp;</td>');
        arr.push('<td colspan="5"><button class="pika-close pika-foot" type="button" alt="Close">&nbsp;</button></td>');
        arr.push('<td class="pika-foot">&nbsp;</td>');
        return '<tr>' + (opts.isRTL ? arr.reverse() : arr).join('') + '</tr>';
    },
    ...
    {
        return '<table cellpadding="0" cellspacing="0" class="pika-table" role="grid" aria-labelledby="' + randId + '">' + renderHead(opts) + renderBody(data) + renderFoot(opts) + '</table>';
    },
    ...
    Pikaday = function(options)
    {
        ...
        self._onClick = function(e)
        {
            ...
            if (hasClass(target, 'pika-close') && self._v) {
                opts.field.blur();
                self.hide();
                return;
            }
        ...
        addEvent(window, 'keydown', self._onKeyChange);
    ...
    Pikaday.prototype = {
        ...
        render: function(year, month, randId)
        {
            ...
            html = renderTable(opts, data, randId);
